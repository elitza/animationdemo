  ...
  var actor2 = scene.createActor('actor.png', 20, 260, 240, 70);
  actor2.pulsates(1, 1, 1);
  scene.write(20, 355, "actor2 pulsates once on load.");

  var actor3 = scene.createActor('actor.png', 350, 260, 240, 70);
  actor3.pulsatesOnTouch(1, 1, 2, 0);
  scene.write(350, 355, "actor3 pulsates twice on touch.");

  var actor4 = scene.createActor('actor.png', 20, 410, 240, 70);
  var actor5 = scene.createActor('actor.png', 350, 410, 240, 70);
