var scene7 = function () {
  ...
  var actor1 = scene.createActor('actor.png', -140, 130 , 240, 70);
  var actor2 = scene.createActor('actor.png', -400, 130, 240, 70);
  actor1.drifts(2, 0);
  // actor1.resetsReactions();
  actor2.clonesMovement(actor1, -100, -100);
  // actor2.resets();

  var actor3 = scene.createActor('actor.png', 20, 300, 240, 70);
  ...
  var actor4 = scene.createActor('actor.png', 20, 470, 240, 70);
  var actor5 = scene.createActor('actor.png', 300, 470, 240, 70);
