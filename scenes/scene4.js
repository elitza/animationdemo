var scene4 = function () {
  ...
  var actor1 = scene.createActor('actor.png', 20, 110, 240, 70);
  actor1.appears(500, 2000);
  scene.write(20, 205, "actor1 appears when the scene loads.");

  var actor3 = scene.createActor('actor.png', 300, 250, 240, 70);
  scene.createActor('actor.png', 20, 250, 240, 70).letsAppear(actor3, 500, 2000);
  // actor2.letsDissolve(actor3, 500);
  scene.write(20, 345, "click on actor2 to let actor3 appear");

  var actor5 = scene.createActor('actors/actor5.png', 285, 400, 240, 70);
  var actor4 = scene.createActor('actors/actor4.png', 20, 400, 240, 70).letsAppear(actor5, 500, 2000).dissolvesOnTouch(2000).letsResetReactions(actor5);
  var actor6 = scene.createActor('actors/actor6.png', 540, 400, 240, 70);
  ...
  var actor7 = scene.createActor('actors/actor7.png', 450, 110, 240, 70);
  var actor8 = scene.createActor('actors/actor8.png', 450, 110, 240, 70);
