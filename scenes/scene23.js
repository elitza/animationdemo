var scene23 = function () {
  ...
  var actor2 = scene.createActor('actors/actor2.png', 250, 270, 240, 88);
  actor2.isInLayer(30);

  var actor3 = scene.createActor('actors/actor3.png', 100, 350, 240, 88);
  actor3.isInLayer(50);

  var actor4 = scene.createActor('actors/actor4.png', 400, 350, 240, 88);
  actor4.isInLayer(50);

  var actor5 = scene.createActor('actors/actor5.png', 250, 420, 240, 88);
