var scene27 = function () {
  ...
  var actor1 = scene.createActor('actor.png', 10, 190, 240, 88).setText("How much is 1 + 1?");
  var actor2 = scene.createActor('actor.png', 270, 190, 240, 88).setText("2");
  var actor3 = scene.createActor('actor.png', 530, 190, 240, 88).setText("3");

  var actor4 = scene.createActor('actor.png', 10, 300, 240, 88).setText("Hoch much is 2 + 3?");
  var actor5 = scene.createActor('actor.png', 270, 300, 240, 88).setText("6");
  var actor6 = scene.createActor('actor.png', 530, 300, 240, 88).setText("5");
